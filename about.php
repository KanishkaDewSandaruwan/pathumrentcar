   ...
   <div class="col-md-12 about-intro">
    <div class="row">
     <div class="col-md-6 d-flex align-items-stretch">
      <div class="img d-flex w-100 align-items-center justify-content-center" style="background-image:url('<?php echo $image_src1; ?>');">
      </div>
    </div>
    <div class="col-md-6 pl-md-5 py-5">
      <div class="row justify-content-start pb-3">
        <div class="col-md-12 heading-section ftco-animate">
         ...
         <h2 class="mb-4"><?php echo $row5['title']; ?></h2>
         <p><?php echo $row5['description']; ?></p>
         <p><a href="index.php" class="btn btn-primary">Book Your Car</a></p>
       </div>
     </div>
   </div>
 </div>
