      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            ...
            <p class="text-lead text-white">Pathum Car rent Login Are. Please Create Account First.</p>
          </div>
        </div>
      </div>
    </div>
            ...
            <div class="card-body">
              ...
              <?php 
                                            ...
                                            if (isset($_POST['submit'])) {
                                                ...
                                                $query3="SELECT * FROM customer WHERE mobile='$phone'";
                                                ...
                                                elseif (mysqli_num_rows($sql4)>0) {
                                                    ...
                                                    $q1="INSERT INTO customer(name,address,mobile,email,nic,password) values('$name','$address','$phone','$email','$nic','".md5($psaaword)."')";
