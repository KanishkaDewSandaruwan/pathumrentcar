...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <main class="main-content mt-1 border-radius-lg">
    ...
    <div class="container-fluid py-4">
        <div class="row">
          <div class="col-md-10">
            <h1 class="text-gray">Edit Car Details</h1>
          </div>
        </div>
        <div class="row">
              <div class="col-md-6 mt-4" style="font-family: \"Times New Roman\",Times, serif;">
                       <form class="reg_form bg-light p-4 border rounded" action="" method="POST" enctype="multipart/form-data">
                            <div class="modal-body">
                                  ...
                                  <div class="form-row">
                                      <div class="form-group col-md-12">
                                        <label for="name" class="a"><b>Car Title</b></label>
                                    ...
                                    if(isset($_POST['submit'])){
                                      ...
                                      $extensions_arr = array("jpg","jpeg","png","gif");
                                        ...
                                        if( in_array($imageFileType,$extensions_arr) ){
                                            ...
                                            $query="UPDATE carreg SET image='$name' where car_id='".$car_id."'";
                                        ...
                                        if(!empty($dealer))
                                        {
                                          $query3="UPDATE carreg SET delar_code='$dealer' WHERE car_id='".$car_id."'";
                                          $sql3=mysqli_query($con,$query3);
                                          echo "<script type=\"text/javascript\"> alert(\"Updated Succussfully\"); window.location= \"car.php\";</script>";
                                        }
                                        ...
                                        {
                                          $query3="UPDATE carreg SET manufacture='$manufacture' WHERE car_id='".$car_id."'";
                                          $sql3=mysqli_query($con,$query3);
                                          echo "<script type=\"text/javascript\"> alert(\"Updated Succussfully\"); window.location= \"car.php\";</script>";
                                        }
                                        if(!empty($model))
                                        {
                                          $query3="UPDATE carreg SET model='$model' WHERE car_id='".$car_id."'";
                                          $sql3=mysqli_query($con,$query3);
                                          echo "<script type=\"text/javascript\"> alert(\"Updated Succussfully\"); window.location= \"car.php\";</script>";
                                        }
                                        ...
                                        if(!empty($color))
                                        {
                                          $query3="UPDATE carreg SET color='$color' WHERE car_id='".$car_id."'";
                                          $sql3=mysqli_query($con,$query3);
                                          echo "<script type=\"text/javascript\"> alert(\"Updated Succussfully\"); window.location= \"car.php\";</script>";
                                        }
                                        if(!empty($chasi))
                                        {
                                          $query3="UPDATE carreg SET chasi_number='$chasi' WHERE car_id='".$car_id."'";
                                          $sql3=mysqli_query($con,$query3);
                                          echo "<script type=\"text/javascript\"> alert(\"Updated Succussfully\"); window.location= \"car.php\";</script>";
                                        }
                                        if(!empty($title))
                                        {
                                          $query3="UPDATE carreg SET title='$title' WHERE car_id='".$car_id."'";
                                          $sql3=mysqli_query($con,$query3);
                                          echo "<script type=\"text/javascript\"> alert(\"Updated Succussfully\"); window.location= \"car.php\";</script>";
                                        }
                                        if(!empty($carnumber))
                                        {
                                          ...
                                          if(mysqli_num_rows($sql3)>0){
                                              ...
                                              $query3="UPDATE carreg SET car_number='$carnumber' WHERE car_id='".$car_id."'";
                                              $sql3=mysqli_query($con,$query3);
                                              echo "<script type=\"text/javascript\"> alert(\"Updated Succussfully\"); window.location= \"car.php\";</script>";
                                            }
                                        }
                                        if(!empty($fee))
                                        {
                                          $query3="UPDATE carreg SET rent_fee='$fee' WHERE car_id='".$car_id."'";
                                          $sql3=mysqli_query($con,$query3);
                                          echo "<script type=\"text/javascript\"> alert(\"Updated Succussfully\"); window.location= \"car.php\";</script>";
                                        }
                                        ...
                                        if(!empty($available))
                                        {
                                          $query3="UPDATE carreg SET available='$available' WHERE car_id='".$car_id."'";
                                          $sql3=mysqli_query($con,$query3);
                                          echo "<script type=\"text/javascript\"> alert(\"Updated Succussfully\"); window.location= \"car.php\";</script>";
                                        }
