        ...
        <div class="row">
              <div class="col-md-6 mt-4" style="font-family: \"Times New Roman\",Times, serif;">
                       <form class="reg_form bg-light p-4 border rounded" action="" method="POST" enctype="multipart/form-data">
                          ...
                          <button type="button" class="btn btn-primary" onclick="window.location.href ='extendrent.php' " data-bs-dismiss="modal">Find New Date</button>
                    ...
                    <div style="font-family: 'Times New Roman', Times, serif;" class="col-md-5 p-5 border border-info bg-gradient-info">
                      ...
                      <div class="row mt-2">
                        ...
                        <?php 
                          ...
                          $last_total = $_REQUEST["total"] + $row6["totle_fee"]; ?>
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-5"><h6 class="text-light">: <?php echo $_REQUEST["extenddate"]; ?></h6></div>
                      </div>
                      <div class="row">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-5"><h6 class="text-light">: <?php echo $_REQUEST["total"];?></h6></div>
                      </div>
                      <div class="row">
