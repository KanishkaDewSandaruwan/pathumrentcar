...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <main class="main-content mt-1 border-radius-lg">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Employee Sallery</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Employee Sallery</h6>
        </nav>
    ...
    <div class="container-fluid py-4">
        <div class="row">
          <div class="col-md-10">
            <h1 class="text-gray">Employee Sallery Payments</h1>
          </div>
        </div>
        <div class="row">
                       ...
                       <form class="reg_form bg-light p-4 border rounded" action="" method="POST" enctype="multipart/form-data">
                            <div class="modal-body">
                              ...
                              <div class="form-row">
                                  ...
                                  <div class="form-group col-md-12">
                                    <label class="text-dark" for="inputState"><b>Select Employee</b></label>
                                    <select id="inputState" name="emp" class="form-control">
                                  ...
                                  <div class="form-row">
                                    <div class="form-group col-md-12">
                                    <label class="text-dark" for="inputState"><b>OT Hours</b></label>
                                      <input type="number" name="ot" id="" class="form-control input-sm chat-input" placeholder="OT Hours"/>
                                    </div>
                                  </div>
                         ...
                         <?php
                                    if(isset($_POST['submit'])){
                                      ...
                                      if (!empty($emp_id)) {
                                        echo "<script type=\"text/javascript\">window.location.href=\"pay_employee_payment.php?emp_id=".$emp_id."&ot=".$ot."\"</script>";
                                      }else{echo "<script type=\"text/javascript\"> alert(\"Select Dealer First\");</script>";}
