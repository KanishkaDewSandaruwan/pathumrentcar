  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-left ms-3" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item ">
          <a class="nav-link  active" href="dealer.php">
  ...
  <main class="main-content mt-1 border-radius-lg">
    ...
    <div class="container-fluid py-4">
        <div class="row">
          ...
          <div class="col-md-10">
            <h1 class="text-gray">Dealer Managment</h1>
          </div>
        </div>
        <div class="row">
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                  ...
                                                  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                    <li><a class="dropdown-item" href="edit_dealer.php?dealer_id=<?php echo $row['dealer_id']; ?>"><i class="fas fa-edit"> Edit</i></a></li>
                                                    <li><a class="dropdown-item" href="delete.php?dealer_id=<?php echo $row['dealer_id']; ?>"><i class="fas fa-trash-alt"> Delete</i></a></li>
                                                  </ul>
                                                </div>
                                            </td>
                                        </tr>
    ...
    <!-- Modal -->
          <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                <h1 style="font-family: \"Times New Roman\",Times, serif; text-align:center" class ="text-danger text-center" >Register Dealer</h1>
                                                                              ...
                                                                              echo "<script>alert(\"Username already Exsisted\");</script>";
                                                                                ...
                                                                                if(mysqli_num_rows($sql3)>0){
                                                                                    echo "<script>alert(\"Email already Exsisted\");</script>";
                                                                                      ...
                                                                                      $q1="INSERT INTO delar(name,address,mobile,email,nic,trndate,password,username) values('$fname','$address','$phone','$emails','$nic','$cdate','".md5($pass)."','$uname')";
                                                                                            $res1=mysqli_query($con,$q1);
                                                                                            if ( $res1) {

                                                                                                 echo '<script>alert("Dealer Registration is Scussessfully."); window.location.href="dealer.php";
                                                                                                              </script>';
                                                                                                
                                                                                            }else{
                                                                                              echo "<script>alert(\"Dealer Registration is Not Scussess\");</script>";
                                                                                            }
                                                                                      }
                                                                                }
                                                                            }
