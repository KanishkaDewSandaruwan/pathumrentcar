...
$q1="INSERT INTO return_car(rent_id,return_date,overlap_days,additional_amount,paid_totle_bill,finished,payment) values('$rent_id','$cdate','0','0','$totle_fee','Yes','No')";
