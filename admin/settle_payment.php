...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <main class="main-content mt-1 border-radius-lg">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Settle Payment</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Settle Payment</h6>
        </nav>
    ...
    <div class="container-fluid py-4">
        <div class="row">
          <div class="col-md-10">
            <h1 class="text-gray">Settle Rent Payments </h1>
          </div>
        </div>
        <div class="row">
              <div class="col-md-6 mt-4" style="font-family: \"Times New Roman\",Times, serif;">
                       <form class="reg_form bg-light p-4 border rounded" action="" method="POST" enctype="multipart/form-data">
                          ...
                          <button type="submit" name="submit" class="btn btn-primary">Settle Payment</button>
                      </form>
                                      ...
                                      $car_number = $row1['car_number'];
                                        ...
                                        if (!empty($paymentoption)) {
                                          if (!empty($amount)) {
                                            ...
                                            if ($row['payment'] == 'Pay Later' && $row2['payment'] == 'Pay Later' ) {

                                              $total = $row['totle_fee'] + $row2['aditional_amount'];

                                                        if ($amount >= $total) {

                                                          $balance = $amount - $total;

                                                              $query3="UPDATE rent SET payment ='Cash' WHERE rent_id='".$rent_id."'";
                                                              mysqli_query($con,$query3);

                                                              $query4="UPDATE extend_rent SET payment ='Cash' WHERE rent_id='".$rent_id."'";
                                            ...
                                            }else if ($row2['payment'] == 'Pay Later') {
                                                $total = $row2['aditional_amount'];
                                            ...
                                            }else{echo "<script>alert(\"All Payment Settled\");</script>"; }
                    ...
                    <div style="font-family: 'Times New Roman', Times, serif;" class="col-md-5 p-5 border border-info bg-gradient-info">
                      ...
                      <div class="row mt-2">
                        ...
                        <?php 
                          ...
                          $viewquery1 = "SELECT * FROM rent where rent_id = ".$rent_id."";
                          $viewresult1 = mysqli_query($con,$viewquery1);
                          $row1 = mysqli_fetch_assoc($viewresult1);
                          $car_id = $row1["car_id"];

                          $viewquery2 = "SELECT * FROM extend_rent where rent_id = ".$rent_id."";
                        ...
                        <div class="col-md-5"><h6 class="text-light">: <?php echo $row["car_number"]; ?></h6></div>
                      </div>
                      <div class="row">
                        <div class="col-md-6"><h6 style="color: green; font-weight: bold;">Start Date & Time  </h6></div>
                        <div class="col-md-5"><h6 class="text-light">: <?php echo $row1["startdate"]; ?></h6></div>
                      </div>
                      <div class="row">
                        <div class="col-md-6"><h6 style="color: green; font-weight: bold;">Due Date & Time </h6></div>
                        <div class="col-md-5"><h6 class="text-light">: <?php echo $row1["due_date"]; ?></h6></div>
                      </div>
                      <?php if ($row1['extend'] == 'Yes') { ?>
                      <div class="row">
                        <div class="col-md-6"><h6 style="color: green; font-weight: bold;">Extended Date & Time </h6></div>
                        <div class="col-md-5"><h6 class="text-light">: <?php echo $row2["extend_date"]; ?></h6></div>
                      </div>
                    <?php } ?>
                      <div class="row">
                        <div class="col-md-6"><h6 style="color: green; font-weight: bold;">Total Amount </h6></div>
                        <div class="col-md-5"><h6 class="text-light">: <?php 

                          if ($row1['payment'] == 'Pay Later' && $row2['payment'] == 'Pay Later' ) {
                              echo $row2['last_amount'];

                            }elseif ($row2['payment'] == 'Pay Later') {
                              echo $row2['aditional_amount'];

                            }elseif ($row1['payment'] == 'Pay Later') {
                              echo $row1['totle_fee'];
                            }
