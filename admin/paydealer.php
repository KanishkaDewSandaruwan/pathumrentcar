...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <main class="main-content mt-1 border-radius-lg">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Add Dealer Payment</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Pay Dealer</h6>
        </nav>
    ...
    <div class="container-fluid py-4">
        <div class="row">
          <div class="col-md-10">
            <h1 class="text-gray">Dealer Payments</h1>
          </div>
        </div>
        <div class="row">
                       ...
                       <form class="reg_form bg-light p-4 border rounded" action="" method="POST" enctype="multipart/form-data">
                            <div class="modal-body">
                              ...
                              <div class="form-row">
                                  ...
                                  <div class="form-group col-md-12">
                                    <label class="text-dark" for="inputState"><b>Select Dealer</b></label>
                         ...
                         <?php
                                    if(isset($_POST['submit'])){
                                      $dealer_id = $_REQUEST['dealer'];

                                      if (!empty($dealer_id)) {
                                        echo "<script type=\"text/javascript\">window.location.href=\"paydealer_payment.php?dealer_id=".$dealer_id."\"</script>";
