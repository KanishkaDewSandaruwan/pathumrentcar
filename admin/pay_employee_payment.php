...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <main class="main-content mt-1 border-radius-lg">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="paysallery.php">Pay Sallery</a></li>
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Confirm Sallery Payment</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Confirm Sallery Payment</h6>
        </nav>
    ...
    <div class="container-fluid py-4">
        <div class="row">
          <div class="col-md-10">
            <h1 class="text-gray">Confirm Sallery Payment</h1>
          </div>
        </div>
        <div class="row">
              <div class="col-md-6 mt-4" style="font-family: \"Times New Roman\",Times, serif;">
                       <form class="reg_form bg-light p-4 border rounded" action="" method="POST" enctype="multipart/form-data">
                          ...
                          <button type="button" class="btn btn-primary" onclick="window.location.href ='paysallery.php' " data-bs-dismiss="modal">Add New</button>
                                      ...
                                      $basic = $row2['basic_salary'];
                                        ...
                                        if (!empty($paymentoption)) {
                                          if (!empty($amount)) {
                                              ...
                                              $q7 = "SELECT * FROM salary_pay where month ='$month' AND employee_id = '$emp_id' ";
                                              $res7 = mysqli_query($con,$q7);

                                              if ($row7=mysqli_fetch_assoc($res7)) {
                                                echo "<script type=\"text/javascript\"> alert(\"This Payment already Settled\"); window.location.href=\"paysallery.php\";</script>";
                                              }else{
                                                    ...
                                                    if ($amount >= $total) {
                                                      ...
                                                      $balance = $amount - $total;
                                                       ...
                                                       $q1="INSERT INTO salary_pay(employee_id,month,basic_salary,ot_houre,ot_amount,salary,paid,trndate) values('$emp_id','$month','$basic','$ot','$total_ot','$total','$paymentoption','$cdate')";
