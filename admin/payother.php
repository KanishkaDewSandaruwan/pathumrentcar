...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <main class="main-content mt-1 border-radius-lg">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Other Payment</li>
          </ol>
    ...
    <div class="container-fluid py-4">
        <div class="row">
          <div class="col-md-10">
            <h1 class="text-gray">Other Payment</h1>
          </div>
        </div>
        <div class="row">
              <div class="col-md-6 mt-4" style="font-family: \"Times New Roman\",Times, serif;">
                       <form class="reg_form bg-light p-4 border rounded" action="" method="POST" enctype="multipart/form-data">
                            <div class="modal-body">
                                    ...
                                    <div class="form-row">
                                       <div class="form-group col-md-12">
                                      <label for="fee"><b>Bill Code</b></label>
                                      <input type="text" class="form-control" name="bcode" placeholder="Bill Code">
                                    </div>
                                    </div>

                                     <div class="form-row">
                                       <div class="form-group col-md-12">
                                      <label for="fee"><b>Amount</b></label>
                                    ...
                                    <div class="form-row">
                                       <div class="form-group col-md-12">
                                      <label for="fee"><b>Bill Date</b></label>
                                      <input type="date" class="form-control" name="bdate" placeholder="Bill Date">
                                    </div>
                                    </div>

                                    <div class="form-row">
                                       <div class="form-group col-md-12">
                                      <label for="fee"><b>Reason</b></label>
                                      <input type="text" class="form-control" name="reson" placeholder="Reason">
                                    </div>
                                    </div>
                          ...
                          <button type="submit" name="submit" class="btn btn-primary">Add Other Payment</button>
                      </form>
                                        ...
                                        if (!empty($bcode)) {
                                          if (!empty($amount)) {
                                            if (!empty($bdate)) {
                                              ...
                                              $q7 = "SELECT * FROM other_payment where bile_code ='$bcode'";
                                              $res7 = mysqli_query($con,$q7);

                                              if ($row7=mysqli_fetch_assoc($res7)) {
                                                echo "<script type=\"text/javascript\"> alert(\"This Payment already Settled\"); window.location.href=\"payment.php\";</script>";
                                              }else{

                                                       $q1="INSERT INTO other_payment(bile_code,amount,billed_date,reson,paid,paid_date) values('$bcode','$amount','$bdate','$reson','Paid','$cdate')";
                                                              $res1=mysqli_query($con,$q1);
                                                        if ( $res1) {

                                                             echo '<script>alert("Other Payment is Scussessfully."); window.location.href="payment.php"; </script>';
                                                            
                                                        }else{
                                                          echo "<script>alert(\"Other Payment is Not Scussess\");</script>";
                                                        }
                                             ...
                                             }else{echo "<script type=\"text/javascript\"> alert(\"Enter Reason\");</script>";}
                                            }else{echo "<script type=\"text/javascript\"> alert(\"Enter Bill Date\");</script>";}
                                          }else{echo "<script type=\"text/javascript\"> alert(\"Enter Bill Amount\");</script>";}
                                        }else{echo "<script type=\"text/javascript\"> alert(\"Select Bill Code\");</script>";}
                    ...
                    <div style="font-family: 'Times New Roman', Times, serif;" class="col-md-5 p-5 border border-info bg-gradient-info">
                      ...
                      <div class="row mt-2">
                        ...
                        <?php 
                          ...
                          $q4 = "SELECT * FROM employee where emp_id ='$emp_id'";
                          $res4 = mysqli_query($con,$q4);
                          $row2=mysqli_fetch_assoc($res4); 

                          $total_ot = $ot * 100;

                          $total = $total_ot + $row2['basic_salary'];
                      ...
                      <div class="row">
                        <div class="col-md-6"><h6 style="color: green; font-weight: bold;">BAsic Sallery </h6></div>
                        <div class="col-md-5"><h6 class="text-light">: <?php echo $row2['basic_salary']; ?></h6></div>
                      </div>
                      <div class="row">
                        <div class="col-md-6"><h6 style="color: green; font-weight: bold;">OT Hours </h6></div>
                        <div class="col-md-5"><h6 class="text-light">: <?php echo $ot; ?></h6></div>
                      </div>
                      <div class="row">
                        <div class="col-md-6"><h6 style="color: green; font-weight: bold;">Total OT Amount </h6></div>
                        <div class="col-md-5"><h6 class="text-light">: <?php echo $total_ot; ?></h6></div>
                      </div>
                      <div class="row">
