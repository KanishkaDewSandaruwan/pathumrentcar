...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <main class="main-content mt-1 border-radius-lg">
    ...
    <div class="container-fluid py-4">
        <div class="row">
          <div class="col-md-10">
            <h1 class="text-gray">Add Rent</h1>
          </div>
        </div>
        <div class="row">
                       ...
                       <form class="reg_form bg-light p-4 border rounded" action="" method="POST" enctype="multipart/form-data">
                            <div class="modal-body">
                                  ...
                                  <div class="form-group col-md-12">
                                    ...
                                    <select id="inputState" name="car" id="car" class="form-control">
                                  ...
                                  <div class="form-row">
                                      <div class="form-group col-md-12">
                                        <label for="name" class="a"><b>Start Date</b></label>
                                        <input type="date" class="form-control" id="duedate" name="startdate" placeholder="Due Date">
                                      </div>
                                    </div>

                                    <div class="form-row">
                                      <div class="form-group col-md-12">
                                        <label for="name" class="a"><b>Start Time</b></label>
                                        <input type="time" class="form-control" id="duedate" name="starttime" placeholder="Start Time">
                                      </div>
                                    </div>
                         ...
                         <?php
                                    if(isset($_POST['submit'])){
                                      ...
                                      $query1="SELECT * FROM rent WHERE car_id='$car'";
                                      ...
                                      if (!empty($car)) {
                                        if ($row1['available'] == 'Yes') {
                                            if (new DateTime($startdate) <= new DateTime($duedate)) {
                                                   ...
                                                   $query2="SELECT * FROM rent WHERE car_id = '$car' AND status != 'Canceled' AND returncar = 'No' AND NOT(due_date < '$startdate' OR startdate > '$duedate') ";
                                                   $sql2=mysqli_query($con,$query2);

                                                    if(mysqli_num_rows($sql2)>0)
                                                    {
                                                      echo "<script type=\"text/javascript\"> alert(\"This Car Not Available this Day\");</script>";
                                                    }
                                                    else
                                                    {
                                                      ...
                                                      $finalstartdate = $startdate." ".$starttime;
                                                      $finalduedate = $duedate." ".$starttime;

                                                      echo '<script>alert("This car is Available. You can Rent. Please Complete Rent"); window.location.href="confirmRent.php?car_id='.$car.'&startdate='.$finalstartdate.'&duedate='.$finalduedate.'&total='.$total.'";</script>';
                                        ...
                                        echo "<script type=\"text/javascript\"> alert(\"Please Select Car\");</script>";
                                      }
