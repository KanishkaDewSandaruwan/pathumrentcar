...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <main class="main-content mt-1 border-radius-lg">
    ...
    <div class="container-fluid py-4">
        <div class="row">
          <div class="col-md-4">
            <h1 class="text-info">Car Rent</h1>
          </div>
        </div>
        <div class="row mt-3">
          <div class="col-md-2">
            <button class="btn btn-lg col-md-12 btn-primary" onclick="window.location.href='rentcar.php'">Rent Car</button>
          </div>
        </div>
          ...
          <div class="row mt-5 ">
              <nav>
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                      <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Rented Car List</a>
                      <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">Returned Car Rent List</a>
                      <a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="false">Extended Car Rent List</a>
                    </div>
                  </nav>
                      ...
                      <div class="col-md-12 mt-4">
                        <div class="card">
                            <div class="table-responsive">
                                <table class="table v-middle" style="height: 500px">
                                    <thead>
                                        <tr class="bg-dark">
                                            ...
                                            <th class="border-top-0 text-white">Starting Date</th>
                                            <th class="border-top-0 text-white">Return Date</th>
                                            <th class="border-top-0 text-white">Total Fee</th>
                                            <th class="border-top-0 text-white">Rented Date</th>
                                            <th class="border-top-0 text-white">Car Pick-Up</th>
                                            <th class="border-top-0 text-white">Extend Date</th>
                                            <th class="border-top-0 text-white">Payment</th>
                                        </tr>
                                    </thead>
                                    <?php 
                                    $viewquery = " SELECT * FROM rent where returncar = 'No' ";
                                    $viewresult = mysqli_query($con,$viewquery);
                                    ...
                                    <tbody>
                                      <?php while($row = mysqli_fetch_assoc($viewresult)) { 
                                        ...
                                        $q6 = "SELECT * FROM extend_rent where rent_id ='$rent_id'";
                                        ...
                                        $q5 = "SELECT * FROM customer where id ='$customer_id'";
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                  ...
                                                  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                    <li><a class="dropdown-item" href="return_car.php?rent_id=<?php echo $row['rent_id']; ?>"><i class="fas fa-edit"> Return Car</i></a></li>
                                                    <li><a class="dropdown-item" href="extendrent.php?rent_id=<?php echo $row['rent_id']; ?>"><i class="fas fa-edit"> Extend Rent</i></a></li>
                                                  <?php if ($row['payment'] == 'Pay Later' || $row1['payment'] == 'Pay Later') {?>
                                                     <div class="dropdown-divider"></div>
                                                    <li><a class="dropdown-item" href="settle_payment.php?rent_id=<?php echo $row['rent_id']; ?>"><i class="fas fa-user-check"> Settle Payment</i></a></li>
                                                  <?php } ?>
                                                     <div class="dropdown-divider"></div>
                                                    <li><a class="dropdown-item" href="managerent.php?pick=<?php echo $row['rent_id']; ?>"><i class="fas fa-user-check"> Pick-Upped</i></a></li>
                                                    <li><a class="dropdown-item" href="managerent.php?accept=<?php echo $row['rent_id']; ?>"><i class="fas fa-user-check"> Accept</i></a></li>
                                                    <li><a class="dropdown-item" href="managerent.php?cancel=<?php echo $row['rent_id']; ?>"><i class="fas fa-window-close"> Cancel</i></a></li>
                                                     <div class="dropdown-divider"></div>
                                                    <li><a class="dropdown-item" href="delete.php?rent_id=<?php echo $row['rent_id']; ?>"><i class="fas fa-trash-alt"> Delete</i></a></li>
                                                  </ul>
                                                </div>
                                            </td>
                                            <td><h6><?php echo $row['status']; ?></h6></td>
                                            <td><h6><?php echo $row2['car_number']; ?><br><?php echo $row2['model']; ?><br><?php echo $row2['color']; ?></h6> <br><img width="100px" src='<?php echo $image_src; ?>'></td>
                                            <td><h6><?php echo $row3['name']; ?> <br><?php echo $row3['address']; ?><br><?php echo $row3['mobile']; ?></h6></td>
                                            <td><h6><?php echo $row['startdate']; ?></h6></td>
                                            <td><h6><?php echo $row['due_date']; ?></h6></td>
                                            <td><h6><?php echo $row['totle_fee']; ?></h6></td>
                                            <td><h6><?php echo $row['trn_date']; ?></h6></td>
                                            <td><h6><?php echo $row['car_pick']; ?></h6></td>
                                            <td><h6><?php echo $row['extend']; ?></h6></td>
                                            <td><h6><?php echo $row['payment']; ?></h6></td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
                                ...
                                <table class="table v-middle">
                                    <thead>
                                        <tr class="bg-dark">
                                            ...
                                            <th class="border-top-0 text-white">Customer</th>
                                            <th class="border-top-0 text-white">Rent</th>
                                            <th class="border-top-0 text-white">Return Date</th>
                                            <th class="border-top-0 text-white">Overlap Days</th>
                                            <th class="border-top-0 text-white">Aditional Amount</th>
                                            <th class="border-top-0 text-white">Total Bill</th>
                                            <th class="border-top-0 text-white">Finish</th>
                                            <th class="border-top-0 text-white">Aditional Payment</th>
                                        </tr>
                                    </thead>
                                    <?php 
                                        ...
                                        <tr>
                                            <td>
                                                <div class="dropdown">
                                                  ...
                                                  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                    <li><a class="dropdown-item" href="delete.php?return_id=<?php echo $row['return_id']; ?>"><i class="fas fa-trash-alt"> Delete</i></a></li>
                                                  </ul>
                                                </div>
                                            </td>
                                            <td><h6><?php echo $row2['car_number']; ?><br><?php echo $row2['model']; ?><br><?php echo $row2['color']; ?></h6></td>
                                            <td><img width="100px" src='<?php echo $image_src; ?>'></td>
                                            <td><h6><?php echo $row3['name']; ?> <br><?php echo $row3['address']; ?><br><?php echo $row3['mobile']; ?></h6></td>
                                            <td><h6><?php echo $row6['startdate']; ?> <br><?php echo $row6['due_date']; ?><br>Extend : <?php echo $row6['returncar']; ?></h6></td>
                                            <td><h6><?php echo $row['return_date']; ?></h6></td>
                                            <td><h6><?php echo $row['overlap_days']; ?></h6></td>
                                            <td><h6><?php echo $row['additional_amount']; ?></h6></td>
                                            <td><h6><?php echo $row['paid_totle_bill']; ?></h6></td>
                                            <td><h6><?php echo $row['finished']; ?></h6></td>
                                            <td><h6><?php echo $row['payment']; ?></h6></td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
                                   ...
                                   <table class="table v-middle">
                                      <thead>
                                          <tr class="bg-dark">
                                              ...
                                              <th class="border-top-0 text-white"></th>
                                              <th class="border-top-0 text-white">Customer</th>
                                              <th class="border-top-0 text-white">Due Date</th>
                                              <th class="border-top-0 text-white">Extend Date</th>
                                              <th class="border-top-0 text-white">Recent Amount</th>
                                              <th class="border-top-0 text-white">Aditional</th>
                                              <th class="border-top-0 text-white">Last Total</th>
                                              <th class="border-top-0 text-white">Date</th>
                                          </tr>
                                      </thead>
                                      <?php 
                                      $viewquery = " SELECT * FROM extend_rent";
                                      $viewresult = mysqli_query($con,$viewquery);
                                      ...
                                      <tbody>
                                        <?php while($row = mysqli_fetch_assoc($viewresult)) { 
                                          ...
                                          $q4 = "SELECT * FROM carreg join rent on carreg.car_id = rent.car_id  where rent.rent_id ='$rent_id'";
                                          $res4 = mysqli_query($con,$q4);
                                          $row2=mysqli_fetch_assoc($res4);
                                          ...
                                          <tr>
                                              <td>
                                                  <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                      <li><a class="dropdown-item" href="delete.php?extend_id=<?php echo $row['extend_id']; ?>"><i class="fas fa-trash-alt"> Delete</i></a></li>
                                                    </ul>
                                                  </div>
                                              </td>
                                              <td><h6><?php echo $row2['car_number']; ?><br><?php echo $row2['model']; ?><br><?php echo $row2['color']; ?></h6></td>
                                            <td><img width="100px" src='<?php echo $image_src; ?>'></td>
                                            <td><h6><?php echo $row3['name']; ?> <br><?php echo $row3['address']; ?><br><?php echo $row3['mobile']; ?></h6></td>
                                              <td><h6><?php echo $row2['due_date']; ?></h6></td>
                                              <td><h6><?php echo $row['extend_date']; ?></h6></td>
                                              <td><h6><?php echo $row2['totle_fee']; ?></h6></td>
                                              <td><h6><?php echo $row['aditional_amount']; ?></h6></td>
                                              <td><h6><?php echo $row['last_amount']; ?></h6></td>
