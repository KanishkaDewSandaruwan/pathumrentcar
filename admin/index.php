                ...
                <div class="col-8">
                  <div class="numbers">
                    <?php 
                      ...
                      $today = 0;
                      $viewquery1 = " SELECT * FROM return_car where DAY(return_date) = DAY(CURRENT_DATE()) AND YEAR(return_date) = YEAR(CURRENT_DATE()) ";
                      $viewresult1 = mysqli_query($con,$viewquery1);

                      while ($row=mysqli_fetch_assoc($viewresult1)) {
                        $today = $today + $row['paid_totle_bill'];
                      } 

                      $total_income_this_month = 0;
                      $viewquery2 = " SELECT * FROM return_car where MONTH(return_date) = MONTH(CURRENT_DATE()) AND YEAR(return_date) = YEAR(CURRENT_DATE()) ";
            ...
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <?php 
                    $viewquery1 = " SELECT * FROM rent where DAY(trn_date) = DAY(CURRENT_DATE()) AND YEAR(trn_date) = YEAR(CURRENT_DATE())";
                    $viewresult1 = mysqli_query($con,$viewquery1); 
                    $rent = mysqli_num_rows($viewresult1);
                    ?>
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Today Rent</p>
                    <h5 class="font-weight-bolder mb-0">
                     <?php echo $rent; ?>
                    </h5>
                  </div>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Total Income This Month</p>
                    <h5 class="font-weight-bolder mb-0">
                      Rs. <?php echo $total_income_this_month; ?>
                    </h5>
                  </div>
                </div>
                <div class="col-4 text-end">
