...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <main class="main-content mt-1 border-radius-lg">
    ...
    <div class="container-fluid py-4">
        <div class="row">
          <div class="col-md-10">
            <h1 class="text-gray">Edit Employee</h1>
          </div>
        </div>
        <div class="row">
                         ...
                         <?php
                                    if(isset($_POST['submit'])){
                                      ...
                                      $id = $_REQUEST['emp_id'];
                                        ...
                                        if(!empty($fname))
                                              {
                                                $query3="UPDATE employee SET name='$fname' WHERE emp_id='".$id."'";
                                                $sql3=mysqli_query($con,$query3);
                                              ...
                                              if(!empty($phone))
                                              {
                                                if(preg_match("/^([0]([0-9])([0-9])([0-9])([0-9])([0-9])([0-9])([0-9])([0-9])([0-9]))$/", $phone)){
                                                    $query3="UPDATE employee SET mobile='$phone' WHERE emp_id='".$id."'";
                                                    $sql3=mysqli_query($con,$query3);
                                                    echo "<script type=\"text/javascript\"> alert(\"Updated Succussfully\"); window.location= \"employee.php\";</script>";
                                            ...
                                            if(!empty($basic))
                                            {
                                              $query3="UPDATE employee SET basic_salary='$basic' WHERE emp_id='".$id."'";
                                              $sql3=mysqli_query($con,$query3);
                                              echo "<script type=\"text/javascript\"> alert(\"Updated Succussfully\"); window.location= \"employee.php\";</script>";
                                            }
