...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <main class="main-content mt-1 border-radius-lg">
    ...
    <div class="container-fluid py-4">
        <div class="row">
          <div class="col-md-10">
            <h1 class="text-gray">Return Repaire</h1>
          </div>
        </div>
        <div class="row">
                       ...
                       <form class="reg_form bg-light p-4 border rounded" action="" method="POST" enctype="multipart/form-data">
                            <div class="modal-body">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                              <?php 
                                                $repaire_id = $_REQUEST['repaire_id'];
                                                $q3 = "SELECT * FROM repair where repaire_id = '$repaire_id' ";
                                              ...
                                              <label for="name" class="a"><b>Car Number</b></label>
                                              <input type="text" class="form-control"  disabled value="<?php echo $row2["car_number"]; ?>" placeholder="Manufacture">
                                            </div>
                                          </div>
                                          ...
                                          <div class="form-row">
                                            <div class="form-group col-md-12">
                                              <?php 
                                                ...
                                                $res3 = mysqli_query($con,$q3);
                                                $row=mysqli_fetch_assoc($res3); ?>
                                              <label for="name" class="a"><b>Sent Date Time</b></label>
                                              <input type="text" class="form-control"  disabled value="<?php echo $row["send_date"]; ?>" placeholder="Manufacture">
                                            </div>
                                          </div>

                                          <div class="form-row">
                                            <div class="form-group col-md-12">
                                              <label><b>Repaired Place</b></label>
                                              <input type="text" class="form-control" name="place" placeholder="Repaired Place">
                                            </div>
                                          </div>

                                          <div class="form-row">
                                          <div class="form-group col-md-12">
                                            <label for="color"><b>Bill Amount</b></label>
                                            <input type="number" class="form-control"  name="amount" placeholder="Bill Amount">
                                          </div>
                                          </div>

                                          <div class="form-row">
                                          <div class="form-group col-md-12">
                                            <label for="chasi"><b>Bill Number</b></label>
                                            <input type="text" class="form-control" name="bilnum" placeholder="Bill Number">
                                          </div>
                                          </div>

                                          <div class="form-row">
                                          <div class="form-group col-md-12">
                                            <label for="inputState"><b>Return</b></label>
                          ...
                          <button type="button" class="btn btn-dark" onclick="window.location.href ='car.php' " data-bs-dismiss="modal">Back</button>
                         ...
                         <?php
                                    if(isset($_POST['submit'])){
                                      ...
                                      $cdate = date("Y/m/d m:H:s");
                                        ...
                                        if(!empty($place))
                                        {
                                          $query3="UPDATE repair SET repaired_place='$place' WHERE repaire_id='".$repaire_id."'";
                                          $sql3=mysqli_query($con,$query3);
                                        ...
                                        if(!empty($amount))
                                        {
                                          $query3="UPDATE repair SET repai_bil_amount='$amount' WHERE repaire_id='".$repaire_id."'";
                                          $sql3=mysqli_query($con,$query3);
                                          echo "<script type=\"text/javascript\"> alert(\"Updated Succussfully\"); window.location= \"car.php\";</script>";
                                        }
                                        if(!empty($bilnum))
                                        {
                                          $query3="UPDATE repair SET bill_number='$bilnum' WHERE repaire_id='".$repaire_id."'";
                                          $sql3=mysqli_query($con,$query3);
                                          echo "<script type=\"text/javascript\"> alert(\"Updated Succussfully\"); window.location= \"car.php\";</script>";
                                        }
                                        if(!empty($available))
                                        {
                                          $query3="UPDATE repair SET finish='$available' WHERE repaire_id='".$repaire_id."'";
                                          $sql3=mysqli_query($con,$query3);
                                          echo "<script type=\"text/javascript\"> alert(\"Updated Succussfully\"); window.location= \"car.php\";</script>";
                                        }
                                        if(!empty($cdate))
                                        {
                                          $query3="UPDATE repair SET resive_date='$cdate' WHERE repaire_id='".$repaire_id."'";
                                          $sql3=mysqli_query($con,$query3);
                                          echo "<script type=\"text/javascript\"> alert(\"Updated Succussfully\"); window.location= \"car.php\";</script>";
                                        }
                                        ...
                                        if($available == 'Yes')
                                        {
                                          $query3="UPDATE carreg SET available='Yes' WHERE car_id='".$car_id."'";
                                          $sql3=mysqli_query($con,$query3);
                                          echo "<script type=\"text/javascript\"> alert(\"Updated Succussfully\"); window.location= \"car.php\";</script>";
                                        }
