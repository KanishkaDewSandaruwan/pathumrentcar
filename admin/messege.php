...
$sql3=mysqli_query($con,$query3); ?>
  ...
  <main class="main-content mt-1 border-radius-lg">
    ...
    <div class="container-fluid py-4">
        <div class="row">
          <div class="col-md-10">
            <h1 class="text-gray">Contact Us Messege</h1>
          </div>
        </div>
        <div class="row">
                                    ...
                                    <tbody>
                                      <?php while($row = mysqli_fetch_assoc($viewresult)) { ?>
                                        <tr>
                                            ...
                                            <td><a style="text-decoration: none; color: red; font-size: 15px;" href="delete.php?m_id=<?php echo $row['m_id']; ?>"><i class="fas fa-trash-alt"> Delete</i></a></td>
                                        </tr>
                                        <?php   $count++; } ?>
                                    </tbody>
                                </table>
