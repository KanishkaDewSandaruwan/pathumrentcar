...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <main class="main-content mt-1 border-radius-lg">
    ...
    <div class="container-fluid py-4">
        <div class="row">
          <div class="col-md-10">
            <h1 class="text-gray">Edit Dealer Details</h1>
          </div>
        </div>
        <div class="row">
              <div class="col-md-12 mt-4" style="font-family: \"Times New Roman\",Times, serif;">
                       <form class="reg_form bg-light p-4 border rounded" action="" method="POST" enctype="multipart/form-data">
                          ...
                          <button type="button" class="btn btn-dark" onclick="window.location.href ='dealer.php' " data-bs-dismiss="modal">Back</button>
                         ...
                         <?php
                                    if(isset($_POST['submit'])){
                                      ...
                                      $id = $_REQUEST['dealer_id'];
                                        ...
                                        if(!empty($fname))
                                              {
                                                $query3="UPDATE delar SET name='$fname' WHERE dealer_id='".$id."'";
                                                $sql3=mysqli_query($con,$query3);
                                                echo "<script type=\"text/javascript\"> alert(\"Updated Succussfully\"); window.location= \"dealer.php\";</script>";
                                              }
                                              if(!empty($emails))
                                              {
                                                if(filter_var($emails, FILTER_VALIDATE_EMAIL)){

                                                  $query1="SELECT * FROM delar WHERE email='$emails'";
                                                  $sql1=mysqli_query($con,$query1);
                                                    ...
                                                    if(mysqli_num_rows($sql1)>0)
                                                    {
                                                      ...
                                                      {
                                                        $query3="UPDATE delar SET email='$emails' WHERE dealer_id='".$id."'";
                                                        $sql3=mysqli_query($con,$query3);
                                                        echo "<script type=\"text/javascript\"> alert(\"Updated Succussfully\"); window.location.href='dealer.php';</script>";
                                                      }
                                                }
                                              }
                                              if(!empty($address))
                                              {
                                                $query3="UPDATE delar SET address='$address' WHERE dealer_id='".$id."'";
                                                $sql3=mysqli_query($con,$query3);
                                                echo "<script type=\"text/javascript\"> alert(\"Updated Succussfully\"); window.location= \"dealer.php\";</script>";
                                              }
                                              if(!empty($phone))
                                              {
                                                if(preg_match("/^([0]([0-9])([0-9])([0-9])([0-9])([0-9])([0-9])([0-9])([0-9])([0-9]))$/", $phone)){
                                                    $query3="UPDATE delar SET mobile='$phone' WHERE dealer_id='".$id."'";
                                                    $sql3=mysqli_query($con,$query3);
                                                    echo "<script type=\"text/javascript\"> alert(\"Updated Succussfully\"); window.location= \"dealer.php\";</script>";
                                              ...
                                              if(!empty($nic))
                                            {
                                              $query3="UPDATE delar SET nic='$nic' WHERE dealer_id='".$id."'";
                                              $sql3=mysqli_query($con,$query3);
                                              echo "<script type=\"text/javascript\"> alert(\"Updated Succussfully\"); window.location= \"dealer.php\";</script>";
                                            }
